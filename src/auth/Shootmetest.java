...
public class Shootmetest implements SipListener {
    ...
    public static final String MyAddress = "163.17.21.85";

    public static final int MyPort = 5020;
	...
	long invco = 1;
	  ...
	  public static String Callee="sis";
...
/*ª`·N*/	  URI request_uri = req.getRequestURI();
